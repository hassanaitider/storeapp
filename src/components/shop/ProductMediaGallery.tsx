    ...
    <div className="space-y-8">
        ...
        >
          {activeUrl ? (
            <div className="relative flex w-full items-center justify-center p-3 sm:p-4">
              ...
              {activeIsGif && (
                <span className="pointer-events-none absolute end-4 top-14 inline-flex items-center gap-1.5 rounded-lg bg-ink-900/80 px-2.5 py-1 text-xs font-bold text-white backdrop-blur-sm sm:top-4 sm:end-28">
            ...
            <div className="relative flex min-h-[16rem] flex-col items-center justify-center gap-2 text-[var(--muted)]">
              ...
              <span className="product-caption">{t.product.mediaHero}</span>
              <div className="absolute end-4 bottom-4 z-10">
                <ImageUploadButton
                  size="lg"
                  label={t.product.uploadMedia}
      ...
      <section aria-label={t.product.mediaGifs}>
        <div className="mb-3 flex items-end justify-between gap-3">
          ...
          <ImageUploadButton size="sm" label="GIF" onUploaded={onUploaded} />
        </div>
